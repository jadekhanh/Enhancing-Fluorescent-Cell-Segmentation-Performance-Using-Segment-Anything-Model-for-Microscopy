...
_MODEL_TYPES = ("vit_h", "vit_b", "vit_l", "vit_t", "vit_b_lm")
...
def get_sam_model(
    ...
    * Windows: C:\Users\<user>\AppData\Local\<AppAuthor>\<AppName>\Cache
    ...
    # If we are finetuning the vit-b-lm model, load the finetuned model
    if model_type == "vit_b_lm":
        checkpoint = "/projectnb/rfpm/SAM_kontact/vit_b_lm.pth"
